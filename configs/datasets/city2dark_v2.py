...
data = dict(samples_per_gpu=2,
            workers_per_gpu=4,
            source_dataset=dict(train=dict(type=source_dataset_type,
                                           data_root=source_data_root,
                                           img_dir='leftImg8bit/train',
                                           ann_dir='gtFine/train',
                                           pipeline=train_pipeline),
                                test=dict(type=source_dataset_type,
                                          data_root=source_data_root,
                                          img_dir='leftImg8bit/val',
                                          ann_dir='gtFine/val',
                                          pipeline=source_test_pipeline)),
            target_dataset=dict(pretrain=dict(type=target_dataset_type,
                                              data_root=target_data_root,
                                              img_dir='train/rgb_anon/train',
                                              ann_dir=None,
                                              pipeline=test_pipeline,
                                              ratio=0.3),
                                train=dict(type=target_dataset_type,
                                           data_root=target_data_root,
                                           img_dir='train/rgb_anon/train',
                                           ann_dir=None,
                                           pipeline=target_train_pipeline,
                                           ratio=0.3),
                                test=dict(type=target_dataset_type,
                                          data_root=target_data_root,
                                          img_dir='val/rgb_anon/val/night',
                                          ann_dir='val/gt/val/night',
                                          pipeline=test_pipeline)),
            target_pseudo_path=f'{target_data_root}work_dirs/train')
